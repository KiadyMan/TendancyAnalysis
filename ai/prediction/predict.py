...
def run_predictions(
    ...
    """Charge le modèle pkl, effectue les projections 2026 et sauvegarde le CSV."""
    with open(model_path, "rb") as f:
        _ = pickle.load(f)

    df, df_monthly, _, _ = load_and_preprocess_features()
    df_2026_list = []
    ...
    for brand in df['Brand'].unique():
        ...
        pred_2026_qty = qty_2025 * (1 + (growth_rate * 0.5))
